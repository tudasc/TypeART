 ...
 */
TYPEART_EXPORT typeart_status typeart_get_subtype(const typeart_struct_layout* container_layout, const void* base_addr,
                                                  size_t offset, typeart_base_type_info* subtype_info,
 ...
 */
TYPEART_EXPORT typeart_status typeart_get_return_address(const void* addr, const void** return_addr);
 ...
 */
TYPEART_EXPORT typeart_status typeart_get_source_location(const void* addr, typeart_source_location* source_loc);
 ...
 */
TYPEART_EXPORT typeart_status typeart_free_source_location(typeart_source_location* source_loc);
 ...
 */
TYPEART_EXPORT typeart_status typeart_resolve_type_id(int type_id, typeart_struct_layout* struct_layout);
 ...
 */
TYPEART_EXPORT const char* typeart_get_type_name(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_valid_type(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_reserved_type(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_builtin_type(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_struct_type(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_userdefined_type(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_union(int type_id);
 ...
 * \return true, false
 */
TYPEART_EXPORT bool typeart_is_vector_type(int type_id);
 ...
 */
TYPEART_EXPORT size_t typeart_get_type_size(int type_id);
 ...
 */
TYPEART_EXPORT const char* typeart_get_project_version();
 ...
 */
TYPEART_EXPORT const char* typeart_get_git_revision();
 ...
 * \return version string
 */
TYPEART_EXPORT const char* typeart_get_llvm_version();
