...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  ...
  set(GCOV_WORKAROUND --rc branch_coverage=1 --rc derive_function_end_line=0)
...
add_custom_target(
  ...
  COMMAND ${TYPEART_LCOV_EXEC} --rc branch_coverage=1 --rc derive_function_end_line=0 --remove typeart.coverage '${CMAKE_BINARY_DIR}/*' -o typeart.coverage
)

add_custom_target(
  typeart-lcov-html
  COMMAND ${TYPEART_GENHTML_EXEC} --rc branch_coverage=1 --rc derive_function_end_line=0 
