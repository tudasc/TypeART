...
// UNSUPPORTED: tsan
// clang-format off
// RUN: TYPEART_SOURCE_LOCATION=error %run %s --mpi_intercept --compile_flags "-g" --executable %s.exe --command "%mpi-exec -n 2 --output-filename %s.log %s.exe" -typeart-call-filter
