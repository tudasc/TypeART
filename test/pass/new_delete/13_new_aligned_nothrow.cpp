...
// CHECK: [[POINTER:%[0-9]+]] = call noalias i8* @_ZnamSt11align_val_tRKSt9nothrow_t(i64 40,
// CHECK-NEXT: call void @__typeart_alloc(i8* [[POINTER]], i32 [[ID:2[5-9][0-9]]], i64 10)

// CHECK: [[POINTER2:%[0-9]+]] = call noalias i8* @_ZnwmSt11align_val_tRKSt9nothrow_t(i64 4,
