...
// CHECK-NEXT: call void @__typeart_alloc(i8* [[POINTER]], i32 12, i64 5)
...
// CHECK-NOT: call void @__typeart_alloc(i8* [[POINTER2]], i32 12, i64 [[SIZE]])
// CHECK: call void @__typeart_alloc(i8* [[POINTER2]], i32 12, i64 %{{[0-9a-z]+}})
