...
// RUN: %c-to-llvm %s | %apply-typeart --typeart-stack=true --typeart-filter=true --typeart-filter-implementation=acg --typeart-filter-cg-file=%p/05_cg.mcg -S 2>&1 | %filecheck %s --check-prefix=CHECK-acg
// clang-format on
