...
// RUN: %c-to-llvm %s | %apply-typeart --typeart-stack --typeart-filter --typeart-filter-implementation=acg --typeart-filter-cg-file=%p/05_cg.ipcg2 -S 2>&1 | %filecheck %s --check-prefix=CHECK-exp-cg
// clang-format on
