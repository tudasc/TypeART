...
// RUN: %c-to-llvm -fno-discard-value-names %omp_c_flags %s | opt -O2 -S | %apply-typeart -typeart-alloca -call-filter -typeart-filter-pointer-stack=false -S | FileCheck %s --check-prefix=check-opt-inst
// REQUIRES: openmp
// clang-format on
