...
lookup_result typeart_support_get_builtin_type(const void* addr, typeart_builtin_type* type);
lookup_result typeart_support_get_type(const void* addr, typeart_type_info* type, size_t* count);
lookup_result typeart_support_resolve_type(int id, size_t* len, const typeart_type_info* types[], const size_t* count[],
